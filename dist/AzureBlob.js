...
class AzureBlob {
    ...
    load(container, filename) {
        return __awaiter(this, void 0, void 0, function* () {
            const getBlobToText = util
                ...
                .bind(this.service);
            const raw = yield getBlobToText(container, filename);
            return raw;
        });
    }
    streams() {
    ...
    getContainerProperties(container) {
        const getContainerProperties = util
    ...
    deleteContainerIfExists(container) {
        const deleteContainerIfExists = util
